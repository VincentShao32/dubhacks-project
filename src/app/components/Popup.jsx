      ...
      {isOpen && (
        <div className="popup-overlay fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center">
          <div className="popup-content bg-white p-6 rounded-lg shadow-lg w-1/2 h-3/4">
            ...
            <p>
              First, start a group order on Uber Eats grab the link you're given. Then, enter the restaurant, link, and when you want to close and place your group order!
              After creating the listing, you will be placed into a group chat with others in your Datch order, where you can communicate and remind them to finalize their orders.
            </p>
            <p>
              <input value={restaurantName} onChange={handleNameChange} placeholder="Restaurant... ex. Chipotle"></input>
              <input value={uberLink} onChange={handleLinkChange}placeholder="Link to Uber Eats group order"></input>
              <input value={orderByTime} onChange={handleTimeChange} className="" placeholder="Place order by... ex. 5:00 PM"></input>
            </p>
            <div>
